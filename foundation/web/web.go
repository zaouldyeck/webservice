...
// pair to the application server mid.
...
// HandleFuncNoMiddleware sets a handler function for a given HTTP method and path
// pair to the application server mux with no middleware.
